...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<!--section class="shipping-calculator-form" style="display:none;"-->
		...
		<p class="form-row form-row-wide" id="calc_shipping_country_field">
            <label><?php echo esc_html('COUNTRY *:' , 'kitgreen') ?></label>
			<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state" rel="calc_shipping_state">
				<option value=""><?php _e( 'Select options', 'woocommerce' ); ?></option>
				<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
                <label><?php echo esc_html('ZIP / POSTAL CODE *:' , 'kitgreen') ?></label>
				<input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_postcode() ); ?>" placeholder="<?php esc_attr_e( 'Postcode / ZIP', 'woocommerce' ); ?>" name="calc_shipping_postcode" id="calc_shipping_postcode" />
			</p>

		<?php endif; ?>

		<p class="cart-submit"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'GET A QUOCTE', 'woocommerce' ); ?></button></p>
