 ...
 * @extends  WC_Widget
 */
class kitgreen_WC_Widget_Price_Filter extends WC_Widget {
...
function register_kitgreen_prie_filter() {
    register_widget('kitgreen_WC_Widget_Price_Filter');
}
add_action('widgets_init', 'register_kitgreen_prie_filter');