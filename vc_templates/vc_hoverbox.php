...
$height =  esc_attr( $atts['el_height'] );
...
$template = <<<HTML
<div class="vc-hoverbox-wrapper $css_class $shape $align $reverse $width $height" $id>
  <div class="vc-hoverbox">
    <div class="vc-hoverbox-inner">
      <div class="vc-hoverbox-inner-child" style="height:$height;">  
      <div class="vc-hoverbox-block vc-hoverbox-front" style="background-image: url($image_src);">
        <div class="vc-hoverbox-block-inner vc-hoverbox-front-inner">
            $primary_title
        </div>
      </div>
      <div class="vc-hoverbox-block vc-hoverbox-back" style="background-image: url($image_src);">
        <div class="overlay_box" style="background-color: $hover_background_color;"></div>
